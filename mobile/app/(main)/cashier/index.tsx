        ...
        <View style={styles.container}>
            ...
            <View style={styles.rightPanel}>
                ...
                <View style={styles.orderTypeContainer}>
                    <TouchableOpacity
                        style={[styles.orderTypeBtn, cart.orderType === 'dine_in' && styles.orderTypeBtnActive]}
                        onPress={() => cart.setOrderType('dine_in')}
                    >
                        <Text style={[styles.orderTypeText, cart.orderType === 'dine_in' && styles.orderTypeTextActive]}>
                            Dine In
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.orderTypeBtn, cart.orderType === 'takeaway' && styles.orderTypeBtnActive]}
                        onPress={() => cart.setOrderType('takeaway')}
                    >
                        <Text style={[styles.orderTypeText, cart.orderType === 'takeaway' && styles.orderTypeTextActive]}>
                            Takeaway
                        </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.cartSummary}>
                    <View style={styles.summaryRow}>
                        ...
                        <Text style={styles.summaryValue}>{formatPrice(cart.getSubtotal())}</Text>
                    </View>
                    <View style={styles.summaryRow}>
                        <Text style={styles.summaryLabel}>Tax (11%)</Text>
                        <Text style={styles.summaryValue}>{formatPrice(cart.getTax())}</Text>
                    </View>
                    <View style={[styles.summaryRow, styles.totalRow]}>
                        <Text style={styles.totalLabel}>Total</Text>
                        <Text style={styles.totalValue}>{formatPrice(cart.getTotal())}</Text>
                    </View>
                </View>
                ...
                <View style={styles.actionButtons}>
                    ...
                    <TouchableOpacity
                        style={[styles.payBtn, cart.items.length === 0 && styles.payBtnDisabled]}
                        onPress={handleSubmitOrder}
                        disabled={cart.items.length === 0}
                    >
                        <Text style={styles.payBtnText}>Pay ({cart.getItemCount()} items)</Text>
                    </TouchableOpacity>
                </View>
            </View>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.tableGrid}>
                            {tables.filter(t => t.status === 'available').map((table) => (
                                <TouchableOpacity
                                    key={table.id}
                                    style={[styles.tableBtn, cart.tableId === table.id && styles.tableBtnActive]}
                                    onPress={() => {
                                        cart.setTableId(table.id);
                                        setShowTableModal(false);
                                    }}
                                >
                                    <Text style={[styles.tableBtnText, cart.tableId === table.id && styles.tableBtnTextActive]}>
                                        {table.number}
                                    </Text>
            ...
            <Modal visible={showPaymentModal} transparent animationType="fade">
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <Text style={styles.paymentTotal}>Total: {formatPrice(cart.getTotal())}</Text>
                        <TextInput
                        ...
                        <View style={styles.paymentActions}>
                            ...
                            <TouchableOpacity
                                style={[styles.confirmPayBtn, processing && styles.payBtnDisabled]}
                    ...
                    <View style={styles.modalContent}>
                        ...
                        {selectedProduct?.variants.map((variant) => (
                            <TouchableOpacity
                                ...
                                onPress={() => handleAddWithVariant(selectedProduct!, variant.id)}
                            >
                                <Text style={styles.variantName}>{variant.name}</Text>
                                <Text style={styles.variantPrice}>
                                    {variant.price_adjustment > 0 ? `+${formatPrice(variant.price_adjustment)}` : formatPrice(selectedProduct.base_price)}
                                </Text>
                            </TouchableOpacity>
                        ))}
                        {selectedProduct?.variants.length === 0 && (
                            ...
                            >
                                ...
                                <Text style={styles.variantPrice}>{formatPrice(selectedProduct.base_price)}</Text>
                            </TouchableOpacity>
                        )}
                        <TouchableOpacity
                            style={styles.modalCloseBtn}
